package org.example.kotlincourse.lessons.lesson15.homework15
...
// Детально описывать не нужно, упражнение на то, чтобы усвоить иерархию наследования и развитие функциональности у наследников.
...
// Он абстрактный, это означает, что нельзя создавать экземлпяр этого класса,

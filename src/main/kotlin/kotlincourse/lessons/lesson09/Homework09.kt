...
// РАБОТА С МАССИВАМИ ARRAY
    val arr01: Array<Int> = arrayOf(1, 2, 3, 4, 5)                    // Создайте массив из 5 целых чисел
    val arr02: Array<String> = Array(10) {" "}                 // Пустой массив строк размером 10 элементов
// Массив из 5 элементов типа Double и заполните его значениями, являющимися удвоенным индексом элемента.
    val arr03: Array<Double> = Array(5) {index -> index * 2.0}
...
// Используйте цикл, чтобы присвоить каждому элементу значение, равное его индексу, умноженному на 3.
    val arr04: Array<Int> = Array(5) {0}
    for (i in arr04) {
        arr04[i] = i * 3
        println(i)
    }
// Создайте массив из 3 nullable строк. Инициализируйте его одним null значением и двумя строками.
    val arr05: Array<String> = Array(3) {" "}

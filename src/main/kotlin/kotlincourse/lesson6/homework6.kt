...
fun main() {
    ...
    typeDoc(".txt")                                 // Задание 5
    temperatureConversion(20.0, "C")  // Задание 6
    choosingClothes(20)                            // Задание 7
    choosingFilms(40)                                    // Задание 8
}
...
// "куртка и шапка" при температуре ниже 0, "ветровка" от 0 до 15 градусов и "футболка и шорты" при температуре выше 15. При температурах ниже -30 и выше +35 рекомендуйте не выходить из дома.
    ...
    fun choosingClothes(temperature: Int) {
        if (temperature in -30 ..0) {
            println("Куртка и шапка")
        } else if (temperature in 0..15) {
            println("Ветровка")
        } else if (temperature in 15..35) {
